...
Blockly.Msg.AUTO_BT_CMD = "BT command %1";  // untranslated
Blockly.Msg.AUTO_BT_DO = "do";  // untranslated
Blockly.Msg.AUTO_BT_MSG = "Send %1 via Bluetooth";  // untranslated
Blockly.Msg.AUTO_BT_TIP1 = "HC-06 Bluetooth command handler";  // untranslated
Blockly.Msg.AUTO_BT_TIP2 = "Send data message via Bluetooth";  // untranslated
Blockly.Msg.AUTO_BUZZER_MESSAGE = "Buzzer set %1";  // untranslated
Blockly.Msg.AUTO_BUZZER_OFF = "Off";  // untranslated
Blockly.Msg.AUTO_BUZZER_ON = "On";  // untranslated
Blockly.Msg.AUTO_BUZZER_TIP = "Buzzer signal generator";  // untranslated
Blockly.Msg.AUTO_CYCLIC_DO = "do";  // untranslated
Blockly.Msg.AUTO_CYCLIC_MESSAGE = "On every %1 ms";  // untranslated
Blockly.Msg.AUTO_CYCLIC_TIP = "Cyclic Timer handler";  // untranslated
Blockly.Msg.AUTO_LCD_MESSAGE = "LCD x: %1 y: %2 text %3";  // untranslated
Blockly.Msg.AUTO_LCD_TIP = "2x16 LCD display";  // untranslated
Blockly.Msg.AUTO_LED_ALL = "All";  // untranslated
Blockly.Msg.AUTO_LED_BACK = "Back";  // untranslated
Blockly.Msg.AUTO_LED_BACKLEFT = "BackLeft";  // untranslated
Blockly.Msg.AUTO_LED_BACKRIGHT = "BackRight";  // untranslated
Blockly.Msg.AUTO_LED_FRONT = "Front";  // untranslated
Blockly.Msg.AUTO_LED_FRONTLEFTG = "FrontLeftG";  // untranslated
Blockly.Msg.AUTO_LED_FRONTLEFTY = "FrontLeftY";  // untranslated
Blockly.Msg.AUTO_LED_FRONTRIGHTG = "FrontRightG";  // untranslated
Blockly.Msg.AUTO_LED_FRONTRIGHTY = "FrontRightY";  // untranslated
Blockly.Msg.AUTO_LED_LEFT = "Left";  // untranslated
Blockly.Msg.AUTO_LED_MESSAGE = "LED %1 %2";  // untranslated
Blockly.Msg.AUTO_LED_OFF = "Off";  // untranslated
Blockly.Msg.AUTO_LED_ON = "On";  // untranslated
Blockly.Msg.AUTO_LED_RIGHT = "Right";  // untranslated
Blockly.Msg.AUTO_LED_TIP = "LED signaling output";  // untranslated
Blockly.Msg.AUTO_LED_TOP = "Top";  // untranslated
Blockly.Msg.AUTO_LED_TOPLEFT = "TopLeft";  // untranslated
Blockly.Msg.AUTO_LED_TOPRIGHT = "TopRight";  // untranslated
Blockly.Msg.AUTO_MOTOR_ALL = "All";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKLEFT = "BackLeft";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKRIGHT = "BackRight";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKWARD = "Backward";  // untranslated
Blockly.Msg.AUTO_MOTOR_FORWARD = "Forward";  // untranslated
Blockly.Msg.AUTO_MOTOR_FRONTLEFT = "FrontLeft";  // untranslated
Blockly.Msg.AUTO_MOTOR_FRONTRIGHT = "FrontRight";  // untranslated
Blockly.Msg.AUTO_MOTOR_LEFT = "Left";  // untranslated
Blockly.Msg.AUTO_MOTOR_MESSAGE = "Motor %1 %2 speed %3";  // untranslated
Blockly.Msg.AUTO_MOTOR_RIGHT = "Right";  // untranslated
Blockly.Msg.AUTO_MOTOR_STOP_MESSAGE = "Motor %1 STOP";  // untranslated
Blockly.Msg.AUTO_MOTOR_STOP_TIP = "DC motor stop action";  // untranslated
Blockly.Msg.AUTO_MOTOR_TIP = "DC motor forward/backward action";  // untranslated
Blockly.Msg.AUTO_ONCE_DO = "do";  // untranslated
Blockly.Msg.AUTO_ONCE_MESSAGE = "In %1 ms";  // untranslated
Blockly.Msg.AUTO_ONCE_TIP = "One shoot Timer handler";  // untranslated
Blockly.Msg.AUTO_USS_MESSAGE = "Ultrasonic Sensor distance";  // untranslated
Blockly.Msg.AUTO_USS_TIP = "Non-contact Ultrasonic distance measurement module";  // untranslated
