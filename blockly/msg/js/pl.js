...
Blockly.Msg.AUTO_BT_CMD = "Na komendę Bluetooth %1";
Blockly.Msg.AUTO_BT_DO = "wykonaj";
Blockly.Msg.AUTO_BT_MSG = "Wyślij %1 przez Bluetooth";
Blockly.Msg.AUTO_BT_TIP1 = "Obsługa komend z interfejsu Bluetooth";
Blockly.Msg.AUTO_BT_TIP2 = "Wysyłanie danych przez interfejs Bluetooth";
Blockly.Msg.AUTO_BUZZER_MESSAGE = "Sygnał dźwiękowy %1";
Blockly.Msg.AUTO_BUZZER_OFF = "Wyłącz";
Blockly.Msg.AUTO_BUZZER_ON = "Włącz";
Blockly.Msg.AUTO_BUZZER_TIP = "Generator sygnału dźwiękowego";
Blockly.Msg.AUTO_CYCLIC_DO = "wykonuj";
Blockly.Msg.AUTO_CYCLIC_MESSAGE = "Co %1 ms";
Blockly.Msg.AUTO_CYCLIC_TIP = "Cykliczne wykonywanie funkcji";
Blockly.Msg.AUTO_LCD_MESSAGE = "LCD kolumna %1 wiersz %2 tekst %3";
Blockly.Msg.AUTO_LCD_TIP = "Wyświetlanie tekstu na LCD 2x16 znaków";
Blockly.Msg.AUTO_LED_ALL = "Wszystkie";
Blockly.Msg.AUTO_LED_BACK = "Tył";
Blockly.Msg.AUTO_LED_BACKLEFT = "Tył-Lewe";
Blockly.Msg.AUTO_LED_BACKRIGHT = "Tył-Prawe";
Blockly.Msg.AUTO_LED_FRONT = "Przód";
Blockly.Msg.AUTO_LED_FRONTLEFTG = "Przód-Lewe Zielone";
Blockly.Msg.AUTO_LED_FRONTLEFTY = "Przód-Lewe Żółte";
Blockly.Msg.AUTO_LED_FRONTRIGHTG = "Przód-Prawe Zielone";
Blockly.Msg.AUTO_LED_FRONTRIGHTY = "Przód-Prawe Żółte";
Blockly.Msg.AUTO_LED_LEFT = "Lewa";
Blockly.Msg.AUTO_LED_MESSAGE = "Światło %1 %2";
Blockly.Msg.AUTO_LED_OFF = "Wyłącz";
Blockly.Msg.AUTO_LED_ON = "Włącz";
Blockly.Msg.AUTO_LED_RIGHT = "Prawa";
Blockly.Msg.AUTO_LED_TIP = "Sterowanie świateł";
Blockly.Msg.AUTO_LED_TOP = "Góra";
Blockly.Msg.AUTO_LED_TOPLEFT = "Góra-Lewe";
Blockly.Msg.AUTO_LED_TOPRIGHT = "Góra-Prawe";
Blockly.Msg.AUTO_MOTOR_ALL = "Wszystkie";
Blockly.Msg.AUTO_MOTOR_BACKLEFT = "Tył-Lewy";
Blockly.Msg.AUTO_MOTOR_BACKRIGHT = "Tył-Prawy";
Blockly.Msg.AUTO_MOTOR_BACKWARD = "Do-tyłu";
Blockly.Msg.AUTO_MOTOR_FORWARD = "Do-przodu";
Blockly.Msg.AUTO_MOTOR_FRONTLEFT = "Przód-Lewy";
Blockly.Msg.AUTO_MOTOR_FRONTRIGHT = "Przód-Prawy";
Blockly.Msg.AUTO_MOTOR_LEFT = "Lewe";
Blockly.Msg.AUTO_MOTOR_MESSAGE = "Silnik(i) %1 %2 prędkość %3";
Blockly.Msg.AUTO_MOTOR_RIGHT = "Prawe";
Blockly.Msg.AUTO_MOTOR_STOP_MESSAGE = "Silnik(i) %1 STOP";
Blockly.Msg.AUTO_MOTOR_STOP_TIP = "Zatrzymywanie silników";
Blockly.Msg.AUTO_MOTOR_TIP = "Sterowanie silnikami (przód/tył)";
Blockly.Msg.AUTO_ONCE_DO = "wykonaj";
Blockly.Msg.AUTO_ONCE_MESSAGE = "Za %1 ms";
Blockly.Msg.AUTO_ONCE_TIP = "Wykonanie funkcji po określonym czasie";
Blockly.Msg.AUTO_USS_MESSAGE = "Odczytaj odległości w";
Blockly.Msg.AUTO_USS_TIP = "Ultradźwiękowy czujnik odległości";
...
Blockly.Msg.CRANE_JOY_LEFT = "Lewy";
Blockly.Msg.CRANE_JOY_MESSAGE = "Odczytaj Joystick";
Blockly.Msg.CRANE_JOY_RIGHT = "Prawy";
Blockly.Msg.CRANE_JOY_SW_MESSAGE = "Przycisk Joysticka";
Blockly.Msg.CRANE_JOY_SW_TIP = "Odczyt przycisku joysticka";
Blockly.Msg.CRANE_JOY_TIP = "Odczyt pozycji joysticka";
Blockly.Msg.CRANE_JOY_X = "Poziom";
Blockly.Msg.CRANE_JOY_XY = "pozycja";
Blockly.Msg.CRANE_JOY_Y = "Pion";
Blockly.Msg.CRANE_MOTOR = "silnik";
Blockly.Msg.CRANE_MOTOR_ANGLE = "kąt";
Blockly.Msg.CRANE_MOTOR_ANGLE_TYPE = "Kąt";
Blockly.Msg.CRANE_MOTOR_BACKWARD = "Do-tyłu";
Blockly.Msg.CRANE_MOTOR_DEPTH = "Przód/Tył";
Blockly.Msg.CRANE_MOTOR_DIR = "Kierunek ruchu";
Blockly.Msg.CRANE_MOTOR_DIR_TIP = "Kierunek ruchu silnika (servo)";
Blockly.Msg.CRANE_MOTOR_FORWARD = "Do-przodu";
Blockly.Msg.CRANE_MOTOR_HANDLE = "Chwytak";
Blockly.Msg.CRANE_MOTOR_HORIZONTAL = "Lewo/Prawo";
Blockly.Msg.CRANE_MOTOR_MOVE = "ruch";
Blockly.Msg.CRANE_MOTOR_POSITION_1 = "Ustaw";
Blockly.Msg.CRANE_MOTOR_POSITION_2 = "pozycja";
Blockly.Msg.CRANE_MOTOR_POSITION_3 = "stopni (-90/+90)";
Blockly.Msg.CRANE_MOTOR_POSITION_GET = "Odczytaj pozycję";
Blockly.Msg.CRANE_MOTOR_POSITION_GET_TIP = "Pobierz bierzącą pozycję silnika (servo)";
Blockly.Msg.CRANE_MOTOR_POSITION_TIP = "Ustawienie pozycji dla silnika krokowego (servo)";
Blockly.Msg.CRANE_MOTOR_SET = "Ruch %1 ustaw %2 prędkość %3 ms/stopień";
Blockly.Msg.CRANE_MOTOR_SETUP_1 = "Konfiguruj";
Blockly.Msg.CRANE_MOTOR_SETUP_2 = "min.";
Blockly.Msg.CRANE_MOTOR_SETUP_3 = "max";
Blockly.Msg.CRANE_MOTOR_SETUP_TIP = "Ustawienie min/max zakresu ruchu silnika (servo)";
Blockly.Msg.CRANE_MOTOR_STOP = "Stop";
Blockly.Msg.CRANE_MOTOR_TIP = "Sterowanie silnikiem krokowym (servo)";
Blockly.Msg.CRANE_MOTOR_TYPE = "Rodzaj silnika";
Blockly.Msg.CRANE_MOTOR_TYPE_TIP = "Rodzaj uywanego silnika (servo)";
Blockly.Msg.CRANE_MOTOR_VERTICAL = "Góra/Dół";
...
Blockly.Msg.PROCEDURES_BEFORE_PARAMS = "parametry:";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "funkcja";
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "funkcja";
...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "czytaj linię analogową#";
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "Wykonuj ciągle:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Uruchom na starcie:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Zdefiniuj działanie za starcie systemu i podczas normalnej pracy.";
Blockly.Msg.ARD_HIGH = "WYSOKI";
Blockly.Msg.ARD_HIGHLOW_TIP = "Set a pin state logic High or Low.";
Blockly.Msg.ARD_LOW = "NISKI";
Blockly.Msg.ARD_MAP = "Przypisz";
Blockly.Msg.ARD_MAP_TIP = "Przypisanie wartości [0-1024] do innej.";
Blockly.Msg.ARD_MAP_VAL = "wartość do [0-";
...
Blockly.Msg.ARD_TYPE_BOOL = "Wartość logiczna";
Blockly.Msg.ARD_TYPE_CHAR = "Znak";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "BlokNiedostępny";
Blockly.Msg.ARD_TYPE_DECIMAL = "Dziesiętny";
Blockly.Msg.ARD_TYPE_LONG = "Numer długi";
Blockly.Msg.ARD_TYPE_NULL = "Puste";
Blockly.Msg.ARD_TYPE_NUMBER = "Numer";
Blockly.Msg.ARD_TYPE_SHORT = "Numer krótki";
Blockly.Msg.ARD_TYPE_TEXT = "Tekst";
Blockly.Msg.ARD_TYPE_UNDEF = "Nie zdefiniowane";
Blockly.Msg.ARD_VAR_AS = "jako";
Blockly.Msg.ARD_VAR_AS_TIP = "Ustaw wartość do wybranego typu";
