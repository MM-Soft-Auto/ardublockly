...
Blockly.Msg.AUTO_BT_CMD = "Na komendę Bluetooth %1";  // untranslated
Blockly.Msg.AUTO_BT_DO = "wykonaj";  // untranslated
Blockly.Msg.AUTO_BT_MSG = "Wyślij %1 przez Bluetooth";  // untranslated
Blockly.Msg.AUTO_BT_TIP1 = "Obsługa komend z interfejsu Bluetooth";  // untranslated
Blockly.Msg.AUTO_BT_TIP2 = "Wysyłanie danych przez interfejs Bluetooth";  // untranslated
Blockly.Msg.AUTO_BUZZER_MESSAGE = "Sygnał dźwiękowy %1";  // untranslated
Blockly.Msg.AUTO_BUZZER_OFF = "Wyłącz";  // untranslated
Blockly.Msg.AUTO_BUZZER_ON = "Włącz";  // untranslated
Blockly.Msg.AUTO_BUZZER_TIP = "Generator sygnału dźwiękowego";  // untranslated
Blockly.Msg.AUTO_CYCLIC_DO = "wykonuj";  // untranslated
Blockly.Msg.AUTO_CYCLIC_MESSAGE = "Co %1 ms";  // untranslated
Blockly.Msg.AUTO_CYCLIC_TIP = "Cykliczne wykonywanie funkcji";  // untranslated
Blockly.Msg.AUTO_LCD_MESSAGE = "LCD kolumna %1 wiersz %2 tekst %3";  // untranslated
Blockly.Msg.AUTO_LCD_TIP = "Wyświetlanie tekstu na LCD 2x16 znaków";  // untranslated
Blockly.Msg.AUTO_LED_ALL = "Wszystkie";  // untranslated
Blockly.Msg.AUTO_LED_BACK = "Tył";  // untranslated
Blockly.Msg.AUTO_LED_BACKLEFT = "Tył-Lewe";  // untranslated
Blockly.Msg.AUTO_LED_BACKRIGHT = "Tył-Prawe";  // untranslated
Blockly.Msg.AUTO_LED_FRONT = "Przód";  // untranslated
Blockly.Msg.AUTO_LED_FRONTLEFTG = "Przód-Lewe Zielone";  // untranslated
Blockly.Msg.AUTO_LED_FRONTLEFTY = "Przód-Lewe Żółte";  // untranslated
Blockly.Msg.AUTO_LED_FRONTRIGHTG = "Przód-Prawe Zielone";  // untranslated
Blockly.Msg.AUTO_LED_FRONTRIGHTY = "Przód-Prawe Żółte";  // untranslated
Blockly.Msg.AUTO_LED_LEFT = "Lewa";  // untranslated
Blockly.Msg.AUTO_LED_MESSAGE = "Światło %1 %2";  // untranslated
Blockly.Msg.AUTO_LED_OFF = "Wyłącz";  // untranslated
Blockly.Msg.AUTO_LED_ON = "Włącz";  // untranslated
Blockly.Msg.AUTO_LED_RIGHT = "Prawa";  // untranslated
Blockly.Msg.AUTO_LED_TIP = "Sterowanie świateł";  // untranslated
Blockly.Msg.AUTO_LED_TOP = "Góra";  // untranslated
Blockly.Msg.AUTO_LED_TOPLEFT = "Góra-Lewe";  // untranslated
Blockly.Msg.AUTO_LED_TOPRIGHT = "Góra-Prawe";  // untranslated
Blockly.Msg.AUTO_MOTOR_ALL = "Wszystkie";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKLEFT = "Tył-Lewy";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKRIGHT = "Tył-Prawy";  // untranslated
Blockly.Msg.AUTO_MOTOR_BACKWARD = "Do-tyłu";  // untranslated
Blockly.Msg.AUTO_MOTOR_FORWARD = "Do-przodu";  // untranslated
Blockly.Msg.AUTO_MOTOR_FRONTLEFT = "Przód-Lewy";  // untranslated
Blockly.Msg.AUTO_MOTOR_FRONTRIGHT = "Przód-Prawy";  // untranslated
Blockly.Msg.AUTO_MOTOR_LEFT = "Lewe";  // untranslated
Blockly.Msg.AUTO_MOTOR_MESSAGE = "Silnik(i) %1 %2 prędkość %3";  // untranslated
Blockly.Msg.AUTO_MOTOR_RIGHT = "Prawe";  // untranslated
Blockly.Msg.AUTO_MOTOR_STOP_MESSAGE = "Silnik(i) %1 STOP";  // untranslated
Blockly.Msg.AUTO_MOTOR_STOP_TIP = "Zatrzymywanie silników";  // untranslated
Blockly.Msg.AUTO_MOTOR_TIP = "Sterowanie silnikami (przód/tył)";  // untranslated
Blockly.Msg.AUTO_ONCE_DO = "wykonaj";  // untranslated
Blockly.Msg.AUTO_ONCE_MESSAGE = "Za %1 ms";  // untranslated
Blockly.Msg.AUTO_ONCE_TIP = "Wykonanie funkcji po określonym czasie";  // untranslated
Blockly.Msg.AUTO_USS_MESSAGE = "Odczytaj odległości w";  // untranslated
Blockly.Msg.AUTO_USS_TIP = "Ultradźwiękowy czujnik odległości";  // untranslated
...
Blockly.Msg.CRANE_JOY_LEFT = "Lewy";  // untranslated
Blockly.Msg.CRANE_JOY_MESSAGE = "Odczytaj Joystick";  // untranslated
Blockly.Msg.CRANE_JOY_RIGHT = "Prawy";  // untranslated
Blockly.Msg.CRANE_JOY_SW_MESSAGE = "Przycisk Joysticka";  // untranslated
Blockly.Msg.CRANE_JOY_SW_TIP = "Odczyt przycisku joysticka";  // untranslated
Blockly.Msg.CRANE_JOY_TIP = "Odczyt pozycji joysticka";  // untranslated
Blockly.Msg.CRANE_JOY_X = "Poziom";  // untranslated
Blockly.Msg.CRANE_JOY_XY = "pozycja";  // untranslated
Blockly.Msg.CRANE_JOY_Y = "Pion";  // untranslated
Blockly.Msg.CRANE_MOTOR = "silnik";  // untranslated
Blockly.Msg.CRANE_MOTOR_ANGLE = "kąt";  // untranslated
Blockly.Msg.CRANE_MOTOR_ANGLE_TYPE = "Kąt";  // untranslated
Blockly.Msg.CRANE_MOTOR_BACKWARD = "Do-tyłu";  // untranslated
Blockly.Msg.CRANE_MOTOR_DEPTH = "Przód/Tył";  // untranslated
Blockly.Msg.CRANE_MOTOR_DIR = "Kierunek ruchu";  // untranslated
Blockly.Msg.CRANE_MOTOR_DIR_TIP = "Kierunek ruchu silnika (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_FORWARD = "Do-przodu";  // untranslated
Blockly.Msg.CRANE_MOTOR_HANDLE = "Chwytak";  // untranslated
Blockly.Msg.CRANE_MOTOR_HORIZONTAL = "Lewo/Prawo";  // untranslated
Blockly.Msg.CRANE_MOTOR_MOVE = "ruch";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_1 = "Ustaw";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_2 = "pozycja";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_3 = "stopni (-90/+90)";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_GET = "Odczytaj pozycję";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_GET_TIP = "Pobierz bierzącą pozycję silnika (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_POSITION_TIP = "Ustawienie pozycji dla silnika krokowego (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_SET = "Ruch %1 ustaw %2 prędkość %3 ms/stopień";  // untranslated
Blockly.Msg.CRANE_MOTOR_SETUP_1 = "Konfiguruj";  // untranslated
Blockly.Msg.CRANE_MOTOR_SETUP_2 = "min.";  // untranslated
Blockly.Msg.CRANE_MOTOR_SETUP_3 = "max";  // untranslated
Blockly.Msg.CRANE_MOTOR_SETUP_TIP = "Ustawienie min/max zakresu ruchu silnika (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_STOP = "Stop";  // untranslated
Blockly.Msg.CRANE_MOTOR_TIP = "Sterowanie silnikiem krokowym (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_TYPE = "Rodzaj silnika";  // untranslated
Blockly.Msg.CRANE_MOTOR_TYPE_TIP = "Rodzaj uywanego silnika (servo)";  // untranslated
Blockly.Msg.CRANE_MOTOR_VERTICAL = "Góra/Dół";  // untranslated
