...
Blockly.Msg.AUTO_BT_CMD = "BT command %1";
Blockly.Msg.AUTO_BT_DO = "do";
Blockly.Msg.AUTO_BT_MSG = "Send %1 via Bluetooth";
Blockly.Msg.AUTO_BT_TIP1 = "HC-06 Bluetooth command handler";
Blockly.Msg.AUTO_BT_TIP2 = "Send data message via Bluetooth";
Blockly.Msg.AUTO_BUZZER_MESSAGE = "Buzzer set %1";
Blockly.Msg.AUTO_BUZZER_OFF = "Off";
Blockly.Msg.AUTO_BUZZER_ON = "On";
Blockly.Msg.AUTO_BUZZER_TIP = "Buzzer signal generator";
Blockly.Msg.AUTO_CYCLIC_DO = "do";
Blockly.Msg.AUTO_CYCLIC_MESSAGE = "On every %1 ms";
Blockly.Msg.AUTO_CYCLIC_TIP = "Cyclic Timer handler";
Blockly.Msg.AUTO_LCD_MESSAGE = "LCD x: %1 y: %2 text %3";
Blockly.Msg.AUTO_LCD_TIP = "2x16 LCD display";
Blockly.Msg.AUTO_LED_ALL = "All";
Blockly.Msg.AUTO_LED_BACK = "Back";
Blockly.Msg.AUTO_LED_BACKLEFT = "BackLeft";
Blockly.Msg.AUTO_LED_BACKRIGHT = "BackRight";
Blockly.Msg.AUTO_LED_FRONT = "Front";
Blockly.Msg.AUTO_LED_FRONTLEFTG = "FrontLeftG";
Blockly.Msg.AUTO_LED_FRONTLEFTY = "FrontLeftY";
Blockly.Msg.AUTO_LED_FRONTRIGHTG = "FrontRightG";
Blockly.Msg.AUTO_LED_FRONTRIGHTY = "FrontRightY";
Blockly.Msg.AUTO_LED_LEFT = "Left";
Blockly.Msg.AUTO_LED_MESSAGE = "LED %1 %2";
Blockly.Msg.AUTO_LED_OFF = "Off";
Blockly.Msg.AUTO_LED_ON = "On";
Blockly.Msg.AUTO_LED_RIGHT = "Right";
Blockly.Msg.AUTO_LED_TIP = "LED signaling output";
Blockly.Msg.AUTO_LED_TOP = "Top";
Blockly.Msg.AUTO_LED_TOPLEFT = "TopLeft";
Blockly.Msg.AUTO_LED_TOPRIGHT = "TopRight";
Blockly.Msg.AUTO_MOTOR_ALL = "All";
Blockly.Msg.AUTO_MOTOR_BACKLEFT = "BackLeft";
Blockly.Msg.AUTO_MOTOR_BACKRIGHT = "BackRight";
Blockly.Msg.AUTO_MOTOR_BACKWARD = "Backward";
Blockly.Msg.AUTO_MOTOR_FORWARD = "Forward";
Blockly.Msg.AUTO_MOTOR_FRONTLEFT = "FrontLeft";
Blockly.Msg.AUTO_MOTOR_FRONTRIGHT = "FrontRight";
Blockly.Msg.AUTO_MOTOR_LEFT = "Left";
Blockly.Msg.AUTO_MOTOR_MESSAGE = "Motor %1 %2 speed %3";
Blockly.Msg.AUTO_MOTOR_RIGHT = "Right";
Blockly.Msg.AUTO_MOTOR_STOP_MESSAGE = "Motor %1 STOP";
Blockly.Msg.AUTO_MOTOR_STOP_TIP = "DC motor stop action";
Blockly.Msg.AUTO_MOTOR_TIP = "DC motor forward/backward action";
Blockly.Msg.AUTO_ONCE_DO = "do";
Blockly.Msg.AUTO_ONCE_MESSAGE = "In %1 ms";
Blockly.Msg.AUTO_ONCE_TIP = "One shoot Timer handler";
Blockly.Msg.AUTO_USS_MESSAGE = "Ultrasonic Sensor distance";
Blockly.Msg.AUTO_USS_TIP = "Non-contact Ultrasonic distance measurement module";
