...
Blockly.Arduino.init = function(workspace) {
    ...
    // Create a dictionary of handlers to check if their use conflicts
    Blockly.Arduino.handlers_ = Object.create(null);
...
Blockly.Arduino.finish = function(code) {
    ...
    code = code.replace(/\n\s+$/, '\n');
    // code = 'void loop() \n{\n' + code + '\n}';
    code = 'void main_Loop(Task * self) \n{\n' + code + '\n}';

    Blockly.Arduino.definitions_['softtimer_include'] = '#include <SoftTimer.h>\n';
    Blockly.Arduino.setups_['softtimer_def_main'] = 'static Task mainTask( 0, main_Loop );';
    Blockly.Arduino.setups_['softtimer_setup_main'] = 'SoftTimer.add( &mainTask );\n';
    ...
    var handlers = [''];
    for (var name in Blockly.Arduino.handlers_) {
        handlers.push(Blockly.Arduino.handlers_[name]);
    }
    ...
    delete Blockly.Arduino.handlers_;
    Blockly.Arduino.variableDB_.reset();
    ...
    var allDefs =
        '//-----------------------------------------------------\n' +
        '//\n' +
        '// Code generated from Blocks for ARDUINO platform\n' +
        '//\n' +
        '//-----------------------------------------------------\n\n' +
        includes.join('\n') + '\n\n' +
        '//-----------------------------------\n' +
